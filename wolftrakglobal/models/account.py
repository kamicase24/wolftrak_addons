...
class AccountInvoice(models.Model):
    ...
    def move_rename(self, state):
        # if state == 'payorder':
        #     if self.move_id:
        #         self.move_id.write({
        #             'name': self.draft_number,
    ...
    draft_number = fields.Char(string='Número Borrador', readonly=False, default=default_draft_number)
    ...
    # Deprecated use payment_term_ids instead
    ...
    def update_ncf_fields(self):
        if not self.ncf_date and self.ncf:
            self.ncf_date = fields.Date.today()
